...
class SearchTagTextVC: UIViewController {
    ...
    func setUpView() {
        ...
        lblSearchText.applyStyle(labelFont: UIFont.applyRegular(fontSize: 12.0), labelColor: AppColor.text)
    ...
    @IBAction func btnNextClicked(_ sender: UIButton) {
        ...
        if self.delegate != nil {
            self.delegate?.searchTagDelegateMethod([kID : "",kTitle : lblSearchText.text!,"tapLocation":tapLocation],tagType: nil)
        }
    ...
    override func viewDidLoad() {
      ...
      self.tblSearch.backgroundColor = AppColor.primaryTheme
...
extension SearchTagTextVC : UISearchBarDelegate {
    
    func searchBarShouldBeginEditing(_ searchBar: UISearchBar) -> Bool {
        
        if imageTagType == .tagBrand {
...
extension SearchTagTextVC : PSTableDelegateDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForFooterInSection section: Int) -> UIView? {
        ...
        lineView.backgroundColor = AppColor.secondaryTheme
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if self.delegate != nil {
            self.delegate?.searchTagDelegateMethod([kID : objectAtIndex.id,kTitle : objectAtIndex.name,"tapLocation" : tapLocation],tagType: nil)
        }
        _ = self.navigationController?.popViewController(animated: true)
    }
}
