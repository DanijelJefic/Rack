...
- (void)drawRect:(CGRect)rect 
{
	...
	for (int i = 0 ; i < numberOfPages ; i++)
	{
		...
		if (i == currentPage)
		{
			if (type == CCPageControlTypeOnFullOffFull || type == CCPageControlTypeOnFullOffEmpty)
			{
		...
		{
			if (type == CCPageControlTypeOnEmptyOffEmpty || type == CCPageControlTypeOnFullOffEmpty)
			{
...
- (void)setType:(CCPageControlType)aType
{
	type = aType ;
