...
let kHeightAspectRasio:CGFloat                  =  1.1
...
let kColorLightGray                 :Int    = 0x828282

struct AppColor {
  static let primaryTheme = UIColor.white
  static let secondaryTheme = UIColor.lightGray

    static let createReckText = UIColor(red: 130.0/255.0, green: 130.0/255.0, blue: 130.0/255.0, alpha: 1.0)
    static let text = UIColor(red: 80.0/255.0, green: 80.0/255.0, blue: 80.0/255.0, alpha: 1.0)
    static let textB = UIColor.black
    static let hashTag = UIColor.blue
    static let darkText = UIColor(red: 40.0/255.0, green: 40.0/255.0, blue: 40.0/255.0, alpha: 1.0)

    static let placeHolder = UIColor(red: 161.0/255.0, green: 159.0/255.0, blue: 159.0/255.0, alpha: 1.0)
    static let btnTitle = UIColor(red: 80.0/255.0, green: 80.0/255.0, blue: 80.0/255.0, alpha: 1.0)
  
    static let borderColor = UIColor.lightGray
    
    static let textLightGray = UIColor.colorFromHex(hex: kColorLightGray)
...
enum EditRackCellType {
    case pinImageCell
    case rackNameCell
    case categoryCell
}

enum EditRackCellActionType {
    case pinImage
    case rackName
    case category
}
...
//MARK:- Store locally profile parameter
let kUserProfileImage : String = "kUserProfileImage"
let kUserProfileBanner : String = "kUserProfileBanner"
...
let kNotificationRackList           : String = "kNotificationRackList"
let kNotificationRackFeedUpdate     : String = "kNotificationRackFeedUpdate"

//MARK:- Other
let mainStoryBoard                  : UIStoryboard = UIStoryboard(name: "Main", bundle: .main)
let secondStoryBoard                : UIStoryboard = UIStoryboard(name: "Second", bundle: .main)
